...
public class VideollamadaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue= Volley.newRequestQueue(VideollamadaActivity.this);
        ...
        RecyclerView recyclerView=findViewById(R.id.list_Videoamadas);
    ...
    //metodo de lista videollamadas
    private void lista_videollamada(){
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        return true;}
    @Override
    //mostrar las opciones que tiene en el menu
