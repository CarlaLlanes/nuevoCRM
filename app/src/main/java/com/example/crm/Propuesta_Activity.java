...
public class Propuesta_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue= Volley.newRequestQueue(Propuesta_Activity.this);
        ...
        RecyclerView recyclerView=findViewById(R.id.list_Propuesta);
    ...
    //metodo de lista prospectos
    private void lista_Propuesta(){
    ...
    public void moveToDescription(ListElement item){
        ...
        //enviar
        Intent intent= new Intent(this,Descripcion_propuesta_Activity.class);
        intent.putExtra("ListElement", item);
        intent.putExtra("correoUsuario",correoUsuario);;
        String ventana="propuesta";
