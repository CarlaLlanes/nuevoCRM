...
public class L_gerente_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lgerente);
        //llamar elementos
        relacionarVistas();
        ...
        requestQueue= Volley.newRequestQueue(L_gerente_Activity.this);
        progressDialog=new ProgressDialog(L_gerente_Activity.this);
        //oyentes botones
