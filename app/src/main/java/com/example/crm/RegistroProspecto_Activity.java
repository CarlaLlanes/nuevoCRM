...
public class RegistroProspecto_Activity extends AppCompatActivity {

    //String para validar campos vacios
    String nombre_Completo,email,numero_Telefono,posible_Ganancia;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registro_prospecto);
        //llamar elementos
        relacionarVistas();
        ...
        requestQueue= Volley.newRequestQueue(RegistroProspecto_Activity.this);
        progressDialog=new ProgressDialog(RegistroProspecto_Activity.this);
        //oyentes botones
    ...
    //Metodo regresa a la pag anterior
    ...
    private void registro_prospecto() {
        IP ip =new IP();
        ...
        if (nombre_Completo.isEmpty() || email.isEmpty()|| numero_Telefono.isEmpty() || posible_Ganancia.isEmpty())
            ...
            StringRequest respuestaConsulta = new StringRequest(Request.Method.POST,
                    ip.getIP()+":3977/api/registroCliente",
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(getApplicationContext(),
                            "Este prospecto ya ha sido registrado",
                            Toast.LENGTH_SHORT).show();
