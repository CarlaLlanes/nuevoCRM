...
public class Cliente_ganado_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cliente_ganado);
        //Relacionar elementos visuales con logica
        relacionarvistas();
        //insancia array para lista
        elements=new ArrayList<>();
        //inicializamos a requestqueue
        requestQueue= Volley.newRequestQueue(Cliente_ganado_Activity.this);
        ...
        RecyclerView recyclerView=findViewById(R.id.list_Clientes_Ganados);
    ...
    //metodo de lista Clientes_Ganados
    private void lista_Clientes_Ganados(){
