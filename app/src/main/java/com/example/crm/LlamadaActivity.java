...
public class LlamadaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue= Volley.newRequestQueue(LlamadaActivity.this);
        ...
        RecyclerView recyclerView=findViewById(R.id.list_Llamadas);
    ...
    //metodo de lista llamadas
    private void lista_Llamadas(){
