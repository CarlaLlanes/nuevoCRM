...
public class Negociacion_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue= Volley.newRequestQueue(Negociacion_Activity.this);
        ...
        RecyclerView recyclerView=findViewById(R.id.list_Negociacion);
    ...
    //metodo de lista Negociacion
    private void lista_Negociacion(){
