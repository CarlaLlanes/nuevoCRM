...
public class HomeActivity extends AppCompatActivity {
    ...
    //tipo de botones
    ImageButton btn_prospecto,btn_propuesta,btn_negociacion,btn_ganado,btn_perdido,btn_chat,
            btn_llamada,btn_videollamada,btn_clientes,btn_actividades;
    @Override
    ...
    public void propuesta(){
        //recibir correo Usuario para mandarlo a propuesta
        //recupero el correo

       String correoUsuario= nombreUsuario.getText().toString();
        //enviar
        Intent intent = new Intent(getApplicationContext(),Propuesta_Activity.class);
